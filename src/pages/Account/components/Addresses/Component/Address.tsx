...
const UserAddedAddress = ({
  ...
  return (
    <Grid container spacing={3}>
      {Array.isArray(addresssNew) && addresssNew?.map((adres) => (
        adres && (
          <Grid item xs={12} sm={6} key={adres?.id || 'default-key'}>
            <Box
              sx={{
                p: 2,
                borderRadius: 2,
            ...
            >
              ...
              >
                <HomeIcon /> {adres?.full_address || 'Adres Yok'}
              </Typography>
              <Typography
                component="div"
                sx={{
              ...
              >
                <PhoneAndroidIcon /> {adres?.phone_number || 'Telefon Yok'}
              </Typography>
              <Stack
                direction="row"
                spacing={1}
